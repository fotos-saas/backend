...
class BulkImportStudentPreviewRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'names.required_without' => 'Adj meg diákneveket vagy tölts fel egy fájlt.',
            ...
            'file.required_without' => 'Adj meg diákneveket vagy tölts fel egy fájlt.',
