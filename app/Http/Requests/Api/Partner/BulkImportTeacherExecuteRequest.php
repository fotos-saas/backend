...
class BulkImportTeacherExecuteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.teacher_id' => 'nullable|integer|exists:teacher_archive,id',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.teacher_id.exists' => 'A megadott tanár nem létezik.',
        ];
    }
}
